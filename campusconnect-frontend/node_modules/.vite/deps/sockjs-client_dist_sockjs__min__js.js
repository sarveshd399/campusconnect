...
var require_sockjs_min = __commonJS({
  "node_modules/sockjs-client/dist/sockjs.min.js"(exports, module) {
    !function(e) {
      ...
      return function i(s, a, l) {
        ...
        r(i, o), i.prototype.removeAllListeners = function(e2) {
          ...
          if (t2) {
            for (var n2 = arguments.length, r2 = new Array(n2 - 1), o2 = 1; o2 < n2; o2++) r2[o2 - 1] = arguments[o2];
            for (var i2 = 0; i2 < t2.length; i2++) t2[i2].apply(this, r2);
          }
        ...
        r.prototype.addEventListener = function(e2, t2) {
          ...
          if (this["on" + t2] && this["on" + t2].apply(this, n2), t2 in this._listeners) for (var r2 = this._listeners[t2], o = 0; o < r2.length; o++) r2[o].apply(this, n2);
        }, t.exports = r;
      }, {}], 6: [function(e, t, n) {
        "use strict";
        var r = e("inherits"), o = e("./event");
          ...
          e2.forEach(function(e3) {
            ...
            r.attachEvent("message", function(t2) {
              if (t2.source === parent && (void 0 === u && (u = t2.origin), t2.origin === u)) {
                ...
                if (n2.windowId === d.currentWindowId) switch (n2.type) {
                  case "s":
                    var e3;
                    try {
                    ...
                    if (m(r2, o2, i, s), r2 !== l.version) throw new Error('Incompatible SockJS! Main site uses: "' + r2 + '", the iframe: "' + l.version + '".');
        ...
        function i(e2, t2) {
          ...
          this.xo = new t2("GET", e2), this.xo.once("finish", function(e3, t3) {
            var n2, r2;
            if (200 === e3) {
              if (r2 = +/* @__PURE__ */ new Date() - i2, t3) try {
                n2 = JSON.parse(t3);
              } catch (e4) {
                a("bad json", t3);
              }
        ...
        (function(w) {
          (function() {
            ...
            function y(e3, t2, n2) {
              if (!(this instanceof y)) return new y(e3, t2, n2);
              ...
              if ("function" == typeof r2) this._generateSessionId = r2;
              else {
                if ("number" != typeof r2) throw new TypeError("If sessionId is used in the options, it needs to be a number or a function.");
              ...
              var o2 = new l(e3);
              if (!o2.host || !o2.protocol) throw new SyntaxError("The URL '" + e3 + "' is invalid");
              if (o2.hash) throw new SyntaxError("The URL must not contain a fragment");
              if ("http:" !== o2.protocol && "https:" !== o2.protocol) throw new SyntaxError("The URL's scheme must be either 'http:' or 'https:'. '" + o2.protocol + "' is not allowed.");
              var i2 = "https:" === o2.protocol;
              if ("https:" === p.protocol && !i2 && !c.isLoopbackAddr(o2.hostname)) throw new Error("SecurityError: An insecure SockJS connection may not be initiated from a page loaded over HTTPS");
              t2 ? Array.isArray(t2) || (t2 = [t2]) : t2 = [];
              var s2 = t2.sort();
              s2.forEach(function(e4, t3) {
                if (!e4) throw new SyntaxError("The protocols entry '" + e4 + "' is invalid.");
                if (t3 < s2.length - 1 && e4 === s2[t3 + 1]) throw new SyntaxError("The protocols entry '" + e4 + "' is duplicated.");
              });
            ...
            e2(y, d), y.prototype.close = function(e3, t2) {
              if (e3 && !g(e3)) throw new Error("InvalidAccessError: Invalid code");
              if (t2 && 123 < t2.length) throw new SyntaxError("reason argument has an invalid length");
              ...
              if ("string" != typeof e3 && (e3 = "" + e3), this.readyState === y.CONNECTING) throw new Error("InvalidStateError: The connection has not been established yet");
              ...
              for (var e3 = this._transports.shift(); e3; e3 = this._transports.shift()) {
                if (b("attempt", e3.transportName), e3.needBody && (!w.document.body || void 0 !== w.document.readyState && "complete" !== w.document.readyState && "interactive" !== w.document.readyState)) return b("waiting for body"), this._transports.unshift(e3), void i.attachEvent("load", this._connect.bind(this));
              ...
              var o2 = false;
              if (this._ir && (o2 = true, this._ir.close(), this._ir = null), this._transport && (this._transport.close(), this._transport = null, this.transport = null), this.readyState === y.CLOSED) throw new Error("InvalidStateError: SockJS has already been closed");
        ...
        function d(e2, t2, n2) {
          for (var r2 in t2) i.hasOwnProperty.call(t2, r2) && o(e2, r2, t2[r2], n2);
        }
        function p(e2) {
          if (null == e2) throw new TypeError("can't convert " + e2 + " to object");
          return Object(e2);
        }
        function m() {
        }
        d(r, { bind: function(t2) {
          var n2 = this;
          if (!a(n2)) throw new TypeError("Function.prototype.bind called on incompatible " + n2);
          for (var r2 = u.call(arguments, 1), e2 = Math.max(0, n2.length - r2.length), o2 = [], i2 = 0; i2 < e2; i2++) o2.push("$" + i2);
        ...
        d(c, { forEach: function(e2, t2) {
          ...
          if (!a(e2)) throw new TypeError();
          for (; ++i2 < s2; ) i2 in r2 && e2.call(o2, r2[i2], i2, n2);
        ...
        d(c, { indexOf: function(e2, t2) {
          ...
          }(t2)), o2 = 0 <= o2 ? o2 : Math.max(0, r2 + o2); o2 < r2; o2++) if (o2 in n2 && n2[o2] === e2) return o2;
          return -1;
        } }, x);
        var _, E = s.split;
        2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function(e2, t2) {
          var n2 = this;
          if (void 0 === e2 && 0 === t2) return [];
          if ("[object RegExp]" !== f.call(e2)) return E.call(this, e2, t2);
          ...
          for (e2 = new RegExp(e2.source, l2 + "g"), n2 += "", _ || (r2 = new RegExp("^" + e2.source + "$(?!\\s)", l2)), t2 = void 0 === t2 ? -1 >>> 0 : function(e3) {
            ...
            for (var e3 = 1; e3 < arguments.length - 2; e3++) void 0 === arguments[e3] && (o2[e3] = void 0);
          }), 1 < o2.length && o2.index < n2.length && c.push.apply(a2, o2.slice(1)), s2 = o2[0].length, u2 = i2, a2.length >= t2)); ) e2.lastIndex === o2.index && e2.lastIndex++;
        ...
        (function(r) {
          (function() {
            ...
            e2(c, i), c.prototype._start = function(e3, t2, n2, r2) {
              ...
              if (r2 && r2.noCredentials || !c.supportsCORS || (u("withCredentials"), this.xhr.withCredentials = true), r2 && r2.headers) for (var i2 in r2.headers) this.xhr.setRequestHeader(i2, r2.headers[i2]);
              ...
              if (u("cleanup"), this.xhr) {
                ...
                }, this.xhr.ontimeout && (this.xhr.ontimeout = null), e3) try {
                  this.xhr.abort();
                } catch (e4) {
                }
        ...
        r(f, i), f.prototype.close = function() {
          ...
          if (c("message", t2.data), s.isOriginEqual(t2.origin, this.origin)) {
            ...
            if (n2.windowId === this.windowId) switch (n2.type) {
              case "s":
            ...
            else c("mismatched window id", n2.windowId, this.windowId);
          } else c("not same origin", t2.origin, this.origin);
        ...
        function i(e2, t2, n2, r2) {
          o.call(this, e2, t2, /* @__PURE__ */ function(s) {
            return function(e3, t3, n3) {
              ...
              return i2.once("finish", function(e4) {
                if (l("finish", e4), i2 = null, 200 !== e4 && 204 !== e4) return n3(new Error("http status " + e4));
                n3();
              }), function() {
        ...
        (function(c) {
          (function() {
            ...
            e2(u, a), u.prototype.abort = function() {
              ...
              }, void 0 === r2.async && c.document.attachEvent) if (s.isOpera()) (t2 = this.script2 = c.document.createElement("script")).text = "try{var a = document.getElementById('" + r2.id + "'); if(a)a.onerror();}catch(x){};", r2.async = t2.async = false;
              else {
                try {
        ...
        r(s, o), s.prototype._chunkHandler = function(e2, t2) {
          if (i("_chunkHandler", e2), 200 === e2 && t2) for (var n2 = -1; ; this.bufferPosition += n2 + 1) {
          ...
          (function() {
            ...
            e2(n, o), n.prototype._start = function(e3, t2, n2) {
              ...
              if (a("cleanup", e3), this.xdr) {
                if (this.removeAllListeners(), i.unloadDel(this.unloadRef), this.xdr.ontimeout = this.xdr.onerror = this.xdr.onprogress = this.xdr.onload = null, e3) try {
                  this.xdr.abort();
                } catch (e4) {
                }
        ...
        (function(n2) {
          (function() {
            ...
            n2.crypto && n2.crypto.getRandomValues ? t.exports.randomBytes = function(e2) {
              ...
              for (var t2 = new Array(e2), n3 = 0; n3 < e2; n3++) t2[n3] = Math.floor(256 * Math.random());
              return t2;
            };
          }).call(this);
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
        ...
        t.exports = { quote: function(e2) {
          ...
          return o.lastIndex = 0, o.test(t2) ? (r = r || function(e3) {
            var t3, n2 = {}, r2 = [];
            for (t3 = 0; t3 < 65536; t3++) r2.push(String.fromCharCode(t3));
        ...
        (function(s) {
          (function() {
            ...
            t.exports = { attachEvent: function(e2, t2) {
              ...
              for (var e2 in r) r[e2](), delete r[e2];
            } };
        ...
        t.exports = { isObject: function(e2) {
          ...
          if (!this.isObject(e2)) return e2;
          for (var t2, n2, r = 1, o = arguments.length; r < o; r++) for (n2 in t2 = arguments[r]) Object.prototype.hasOwnProperty.call(t2, n2) && (e2[n2] = t2[n2]);
          return e2;
        } };
      }, {}], 50: [function(e, t, n) {
        "use strict";
        ...
        t.exports = { string: function(e2) {
          for (var t2 = s.length, n2 = i.randomBytes(e2), r = [], o = 0; o < e2; o++) r.push(s.substr(n2[o] % t2, 1));
          return r.join("");
        }, number: function(e2) {
        ...
        t.exports = { getOrigin: function(e2) {
          if (!e2) return null;
          var t2 = new r(e2);
          if ("file:" === t2.protocol) return null;
          var n2 = t2.port;
        ...
        n.stringify = function(e2, t2) {
          t2 = t2 || "";
          var n2, r, o = [];
          for (r in "string" != typeof t2 && (t2 = "?"), e2) if (i.call(e2, r)) {
            if ((n2 = e2[r]) || null != n2 && !isNaN(n2) || (n2 = ""), r = encodeURIComponent(r), n2 = encodeURIComponent(n2), null === r || null === n2) continue;
            o.push(r + "=" + n2);
          }
        ...
        "use strict";
        t.exports = function(e2, t2) {
          if (t2 = t2.split(":")[0], !(e2 = +e2)) return false;
          switch (t2) {
            case "http":
            case "ws":
              return 80 !== e2;
        ...
        (function(a) {
          (function() {
            ...
            function g(e2) {
              ...
              if ("blob:" === e2.protocol) r = new _(unescape(e2.pathname), {});
              else if ("string" == o) for (t3 in r = new _(e2, {}), s) delete r[t3];
              else if ("object" == o) {
                for (t3 in e2) t3 in s || (r[t3] = e2[t3]);
